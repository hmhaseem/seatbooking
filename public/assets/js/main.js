...
document.getElementById("layout-menu") &&
    ...
    (function () {
        ...
        function s(o) {
            [].slice
                .call(document.querySelectorAll("[data-app-" + o + "-img]"))
                .map(function (e) {
        ...
        window.templateCustomizer &&
            ...
            window.Helpers.isLightStyle()
                ? (t &&
                      (t.querySelector("i").classList.add("bx-moon"),
                  ...
                  s("light"))
                : (t &&
                      (t.querySelector("i").classList.add("bx-sun"),
                      new bootstrap.Tooltip(t, {
                          title: "Light mode",
                          fallbackPlacements: ["bottom"],
                      })),
            ...
            for (let e = 0; e < l.length; e++)
                l[e].addEventListener("click", function () {
                    ...
                    this.classList.add("selected"),
                        (a[0].querySelector(".dropdown-toggle .fi").className =
                            t),
    ...
    "undefined" != typeof $ &&
        $(function () {
            ...
            n.length &&
                ...
                a.on("focus", function () {
                    s.hasClass("container-xxl") &&
                        s.find(".twitter-typeahead").addClass("container-xxl");
                }),
                a.length &&
                    ((t = function (n) {
                        return function (t, e) {
