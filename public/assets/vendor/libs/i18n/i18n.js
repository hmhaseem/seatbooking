!(function () {
                    ...
                    !(function (t) {
                        ...
                        (p.prototype.append = function (e, t) {
                            ...
                            (p.prototype.get = function (e) {
                                return (
                                    (e = c(e)), this.has(e) ? this.map[e] : null
                                );
                            }),
    ...
    !(function () {
                    ...
                    o(e, [
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                this.observers[e] &&
                                    (t
                                        ? (this.observers[e] = this.observers[
                                              e
                                          ].filter(function (e) {
                                              return e !== t;
                                          }))
        ...
        function A(e, t) {
            ...
            if (e) {
                ...
                for (var o = t.split(n), r = e, i = 0; i < o.length; ++i) {
                    ...
                    if (void 0 === r[o[i]]) {
                        for (
                            var a = 2, s = o.slice(i, i + a).join(n), u = r[s];
                            void 0 === u && o.length > i + a;

                        )
                            a++, (u = r[(s = o.slice(i, i + a).join(n))]);
                        if (void 0 === u) return;
            ...
            F = {
                ...
                handle: function (e, t, n, o, r) {
                    ...
                    return (
                        e.forEach(function (e) {
                            i.processors[e] &&
                                (t = i.processors[e].process(t, n, o, r));
                        }),
                        t
                    );
                },
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    if (i && !a) {
                                        var s = e.match(
                                            this.interpolator.nestingRegexp
                                        );
                                        if (s && s.length > 0)
                                            return { key: e, namespaces: r };
                                        var u = e.split(n);
                                        (n !== o ||
                                            (n === o &&
                                                this.options.ns.indexOf(u[0]) >
                                                    -1)) &&
                                            (r = u.shift()),
                                            (e = u.join(o));
                                    }
                            ...
                            },
                            {
                                ...
                                value: function (t, n, o) {
                                    ...
                                    var g = this.resolve(t, n),
                                        ...
                                        k =
                                            !this.i18nFormat ||
                                            this.i18nFormat.handleAsObject,
                                        x =
                                            "string" != typeof y &&
                                            "boolean" != typeof y &&
                                            "number" != typeof y;
                                ...
                                value: function (e) {
                                    return !(
                                        ...
                                        (!this.options.returnNull &&
                                            null === e) ||
                                        (!this.options.returnEmptyString &&
                                            "" === e)
                                    );
                                },
                            },
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return o
                                ...
                                : (this.logger.warn(
                                      "no plural rule found for: ".concat(e)
                                  ),
                                  "");
                        },
                    },
                        ...
                        value: function (e, t) {
                            ...
                            function s(e, t) {
                                ...
                                var o = e.split(
                                    ...
                                    r = "{".concat(o[1]);
                                e = o[0];
                                var i = (r = this.interpolate(r, a)).match(
                                        /'/g
                                    ),
                                    s = r.match(/"/g);
                                ((i && i.length % 2 == 0 && !s) ||
                    ...
                    (this.formats = {
                        ...
                        currency: function (e, t, n) {
                            return new Intl.NumberFormat(
                                t,
                                Z(Z({}, n), {}, { style: "currency" })
                            ).format(e);
                        },
                        datetime: function (e, t, n) {
                            return new Intl.DateTimeFormat(t, Z({}, n)).format(
                                e
                            );
                        },
                        ...
                        list: function (e, t, n) {
                            return new Intl.ListFormat(t, Z({}, n)).format(e);
                        },
                    }),
                    this.init(n);
            }
        ...
        var oe = (function (e) {
            ...
            function s(e, n, o) {
                ...
                return (
                    ...
                    (r.waitingReads = []),
                    (r.maxParallelReads = u.maxParallelReads || 10),
                    (r.readingCalls = 0),
                    (r.maxRetries = u.maxRetries >= 0 ? u.maxRetries : 5),
                    (r.retryTimeout =
                        ...
                        value: function (e, t, n, o, r) {
                            ...
                            !this.services.utils.hasLoadedNamespace(t)
                                ...
                                : null != n &&
                                  ...
                                  e &&
                                      e[0] &&
                                      this.store.addResource(e[0], t, n, o));
                        },
                    },
                ]),
                s
                ...
                o(f, [
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ((this.options = se(
                                    se(se({}, o), this.options),
                                    ie(t)
                                )),
                                "v1" !== this.options.compatibilityAPI &&
                                    (this.options.interpolation = se(
                                        se({}, o.interpolation),
                                        this.options.interpolation
                                    )),
                                void 0 !== t.keySeparator &&
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                (r.services = se({}, this.services)),
                                (r.services.utils = {
                                    hasLoadedNamespace:
                                        r.hasLoadedNamespace.bind(r),
                                }),
                                (r.translator = new B(r.services, r.options)),
        ...
        function ve(e) {
            return (
                ge.call(ye.call(arguments, 1), function (t) {
        ...
        "function" == typeof fetch &&
            ...
            me() &&
                ("undefined" != typeof global && global.XMLHttpRequest
                    ? (we = global.XMLHttpRequest)
                    : "undefined" != typeof window &&
                      window.XMLHttpRequest &&
                      (we = window.XMLHttpRequest)),
            "function" == typeof ActiveXObject &&
                ("undefined" != typeof global && global.ActiveXObject
                    ? (Oe = global.ActiveXObject)
                    : "undefined" != typeof window &&
                      window.ActiveXObject &&
                      (Oe = window.ActiveXObject)),
            be || !xe || we || Oe || (be = ke || xe),
            "function" != typeof be && (be = void 0);
        var je = function (e, t) {
                if (t && "object" === Se(t)) {
                    var n = "";
                    for (var o in t)
            ...
            Re = function (e, t, n, o) {
                return (
                    ...
                    be
                        ...
                        : me() || "function" == typeof ActiveXObject
                        ? (function (e, t, n, o) {
                              n &&
                                  "object" === Se(n) &&
                                  (n = je("", n).slice(1)),
                              ...
                              try {
                                  ...
                                  (r = we
                                      ? new we()
                                      : new Oe("MSXML2.XMLHTTP.3.0")).open(
                                      n ? "POST" : "GET",
                                      t,
                                      1
                                  ),
                                ...
                                if (!i || "cimode" !== i.toLowerCase()) {
                                    ...
                                    s(i),
                                        ...
                                        a.forEach(function (t) {
                                            e.allOptions.ns.forEach(function (
                                                e
                                            ) {
                                                n.read(
                                                    t,
        ...
        function Ue(e) {
            return (
                Ie.call(Fe.call(arguments, 1), function (t) {
                    if (t) for (var n in t) void 0 === e[n] && (e[n] = t[n]);
                }),
                e
            );
        ...
        var _e = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
                ...
                lookup: function (e) {
                    ...
                    if ("undefined" != typeof window) {
                        ...
                        for (
                            ...
                            var i = o[r].indexOf("=");
                            i > 0 &&
                                o[r].substring(0, i) === e.lookupQuerystring &&
                                (t = o[r].substring(i + 1));
                        }
                    }
                    return t;
            ...
            Ve = function () {
                ...
                try {
                    qe = "undefined" !== window && null !== window.localStorage;
                                ...
                                var t =
                                    ...
                                    n =
                                        ...
                                        void 0 !== arguments[2]
                                            ...
                                            : {};
                                (this.services = e),
                                    (this.options = Ue(t, this.options || {}, {
                                        order: [
                                            "querystring",
                                            "cookie",
                                            "localStorage",
