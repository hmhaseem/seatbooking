!(function () {
    ...
    function d(t) {
        throw new Error(
            "Parameter required".concat(t ? ": `".concat(t, "`") : "")
        );
    }
    var h = {
            ...
            if (n) {
                ...
                if (i) {
                    ...
                    if (
                        ...
                        "number" != typeof i &&
                            (i = i.getBoundingClientRect().top + r.scrollTop),
        ...
        _toggleClass: function () {
            ...
            t.classList.contains(e)
                ? t.classList.replace(e, n)
                : t.classList.replace(n, e);
        },
        ...
        _bindLayoutAnimationEndEvent: function (t, e) {
            ...
            (this._transitionCallback = function (t) {
                t.target === i &&
                    (n._unbindLayoutAnimationEndEvent(), e.call(n));
            }),
            ...
            if (
                ...
                this._menuMouseEnter ||
                    ((this._menuMouseEnter = function () {
                        return t.isSmallScreen() ||
                            !t._hasClass("layout-menu-collapsed") ||
                            t.isOffcanvas() ||
                            t._hasClass("layout-transitioning")
                            ? t._setMenuHoverState(!1)
                            : t._setMenuHoverState(!0);
                    }),
                    ...
                    this._windowTouchStart ||
                        ((this._windowTouchStart = function (e) {
                            (e &&
                                e.target &&
                                t._findParent(e.target, ".layout-menu")) ||
                                t._setMenuHoverState(!1);
                        }),
        ...
        scrollPageTo: function (t) {
            ...
            "string" == typeof t && (t = document.querySelector(t)),
                "number" != typeof t &&
                    (t = t.getBoundingClientRect().top + i.scrollTop);
            var o = i.scrollTop,
                r = t - o,
                s = +new Date(),
                a = function a() {
            ...
            t.checked
                ? ("radio" === t.type &&
                      [].slice
                          ...
                          .map(function (t) {
                              t.closest(".custom-option").classList.remove(
                                  "checked"
                              );
                          }),
        ...
        isLayoutNavbarFull: function () {
            return !!document.querySelector(
                ".layout-wrapper.layout-navbar-full"
            );
        },
        ...
        on: function () {
            var t =
                ...
                l = u.slice(1);
            (l = l.join(".") || null),
                this._listeners.push({ event: s, namespace: l, callback: e });
        },
        off: function () {
            var t = this,
                e =
                ...
                this.on("init._Helpers", function () {
                    t.off("resize._Helpers:redrawMenu"),
                        ...
                        "number" == typeof document.documentMode &&
                            ...
                            (t.off("resize._Helpers:ie10RepaintBody"),
                            t.on(
                                "resize._Helpers:ie10RepaintBody",
                                function () {
                                    if (!t.isFixed()) {
                                        var e =
        ...
        initSpeechToText: function () {
            ...
            if (null != t && null != e) {
                var n = new t();
                document
                    .querySelectorAll(".speech-to-text i")
                    .forEach(function (t) {
                        var e = !1;
        ...
        initNavbarDropdownScrollbar: function () {
            ...
            void 0 !== e &&
                null != t &&
                t.forEach(function (t) {
                    new e(t, { wheelPropagation: !1, suppressScrollX: !0 });
                });
        },
        ajaxCall: function (t) {
    ...
    var f = window;
    for (var v in e) f[v] = e[v];
    e.__esModule && Object.defineProperty(f, "__esModule", { value: !0 });
})();
