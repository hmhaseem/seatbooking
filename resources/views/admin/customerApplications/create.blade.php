...
@section('content')
    <div class="card">
        ...
        <div class="col-12 mb-4">
            ...
            <div id="wizard-validation" class="bs-stepper  wizard-modern wizard-vertical vertical mt-2">
                ...
                <div class="bs-stepper-content">
                    <form method="POST" action="{{ route('admin.customer-applications.store') }}"
                        ...
                        <div id="account-details-validation" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{ $errors->has('nic') ? 'is-invalid' : '' }}" type="text"
                                        name="nic" id="nic" value="{{ old('nic', '') }}" required>
                                    @if ($errors->has('nic'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('nic') }}
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{ $errors->has('address2') ? 'is-invalid' : '' }}"
                                        type="text" name="address2" id="address2" value="{{ old('address', '') }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}"
                                        type="text" name="city" id="city" value="{{ old('address', '') }}"
                                        required>
